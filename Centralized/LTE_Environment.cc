...

{
    ...
    uint16_t nMacroUes = 80; // Number of users with realistic mobility model
    ...
    if (m_mobility == 1) {
        ...
        enbPositionAlloc->Add(Vector(796.8938352346304, 2118.770895089954, 30)); //L6183

        enbPositionAlloc->Add(Vector(1371.877438257332, 2331.1886772192083, 30)); //L6541

        enbPositionAlloc->Add(Vector(1354.4832434408017, 1791.0314224967733, 30)); //LK2313

        enbPositionAlloc->Add(Vector(1756.5697463185643, 1924.1612803018652, 30)); //LK2331

        enbPositionAlloc->Add(Vector(1857.1249418809894, 2368.2851388552226, 30)); //LK2526
        
        enbPositionAlloc->Add(Vector(2291.7522011126857, 1929.4412568900734, 30)); //LK6606
    ...
    if (m_mobility == 1) {
        ...
        m_traceFile = "scratch/RealSce/tcls_80/mob.tcl"; 
